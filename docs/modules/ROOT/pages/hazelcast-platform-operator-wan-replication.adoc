...
----
kubectl apply -f - <<EOF
include::ROOT:example$/hazelcast-first.yaml[]
EOF
----
...
----
kubectl apply -f - <<EOF
include::ROOT:example$/hazelcast-second.yaml[]
EOF
----
+
...
----
kubectl apply -f - <<EOF
include::ROOT:example$/wanreplication.yaml[]
EOF
----
...
----
+
The sample code(excluding CLC) for this tutorial is in the link:https://github.com/hazelcast-guides/hazelcast-platform-operator-wan-replication/tree/master/docs/modules/ROOT/examples[`docs/modules/ROOT/examples/`] directory.
